...
AddNoticeButton = Button(window, text="Add Notices!", bg="yellow", fg="green", command=add_notices)
AddNoticeButton.place(relx=0.532, rely=0.672, height=70, width=120)
...
def chat_click(receiverid, fullname):
    ...
    Label1.destroy()
    AddNoticeButton.destroy()
    ANUButton.destroy()
    chatserverbutton.destroy()
    videoserverbutton.destroy()
    audioserverbutton.destroy()
...
# chat server button
chatserverbutton = Button(window, text="Start chat server", command=logout, bg="red")
chatserverbutton.place(relx=0.877, rely=0.1, height=35, width=98)
# video server button
videoserverbutton = Button(window, text="Start video server", command=logout, bg="red")
videoserverbutton.place(relx=0.877, rely=0.2, height=35, width=98)
# audio server button
audioserverbutton = Button(window, text="Start audio server", command=logout, bg="red")
audioserverbutton.place(relx=0.877, rely=0.3, height=35, width=98)
