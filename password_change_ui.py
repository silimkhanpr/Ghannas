...
label4 = Label(window, fg="green")
label4.place(relx=0.267, rely=0.533, height=35, width=136)
...
def clicked(event=None):
    ...
    if entry1.get()and entry2.get(): 
        if pass2==pass1:
            ...
            messagebox.showerror('Password change Failure!', 'Entered password doesnt match the original password')
    else:
         messagebox.showerror('Password change Failure!', 'All the fields are mandatory')
