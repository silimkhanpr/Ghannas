...
-- Database: `be_project`
--
CREATE DATABASE IF NOT EXISTS `be_project` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `be_project`;

-- --------------------------------------------------------

--
-- Table structure for table `chat_ports`
--

CREATE TABLE `chat_ports` (
...
--
-- Dumping data for table `chat_ports`
--

INSERT INTO `chat_ports` (`host1`, `host2`, `port`) VALUES
(1, 2, 3001),
(1, 3, 3002),
(1, 4, 3004);
...
(3, 1, 'Nandan Prabhudesai', 'Ui designer', 'nandanprabhudesai@gmail.com', '1997-03-25', '192.168.1.36'),
...
INSERT INTO `message` (`Message_ID`, `Message_body`, `Sender_id`, `Receiver_Id`, `Receiver_group_id`, `message_type`, `Port_no`, `time`) VALUES
(13, 'hello', 2, 4, NULL, 'personal', 0, '2019-04-17 13:43:20'),
(14, 'hiii', 4, 2, NULL, 'personal', 0, '2019-04-03 09:26:32'),
(15, 'dgdge', 2, 4, NULL, 'personal', 0, '2019-04-17 13:42:55'),
(16, 'hey', 4, 2, NULL, 'personal', 0, '2019-04-17 13:43:04'),
(17, 'bro', 4, NULL, 3, 'group', 0, '2019-04-17 07:02:37'),
(18, 'chats is working', 3, NULL, 3, 'group', 0, '2019-04-17 07:02:43'),
(19, 'sup', 4, NULL, 3, 'group', 0, '2019-04-17 07:02:46'),
(20, 'array bro', 3, NULL, 3, 'group', 0, '2019-04-17 07:02:49'),
(21, 'hiiiii', 1, 2, NULL, 'personal', 0, '2019-04-18 05:47:19'),
(22, 'hellooooo', 1, 2, NULL, 'personal', 0, '2019-04-18 05:47:23'),
(23, 'hey', 3, NULL, 3, 'group', 0, '2019-04-18 16:14:24');
